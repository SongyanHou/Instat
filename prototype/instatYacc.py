...
def p_for_statement(p):
    """ for_statement : FOR ID IN or_expression TO or_expression COLON NEWLINE LBRACK statement RBRACK
    """
    p[0] = Node("for_statement", [p[4], p[6], p[10]], p[2])
    #print p[0]

def p_iteration_statement(p):
    """ iteration_statement : WHILE LPAREN or_expression RPAREN COLON NEWLINE LBRACK statement RBRACK
    """
    p[0] = Node("iteration_statement", [p[3], p[8]])
    print p[0]

def p_selection_statement(p):
    """ selection_statement : IF LPAREN or_expression RPAREN COLON NEWLINE LBRACK statement RBRACK
                            | IF LPAREN or_expression RPAREN COLON NEWLINE LBRACK statement RBRACK ELSE COLON NEWLINE LBRACK statement RBRACK
    """
    if len(p) == 10:
